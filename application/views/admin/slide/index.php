                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        ...
                        <div class="dropdown no-arrow">
                            <a href="<?= base_url('admin/slide/add_slide') ?>">
                            ...
                            <table class="table text-center" id="dataTable">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td><?php echo $num; ?></td>
                                            <td><img src="<?= base_url('assets/img/admin/') . $row['slider_img']; ?> " alt="" width="100px"></td>
                                            <td><?php echo $row['slider_num']; ?></td>
                                            <td>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="<?= base_url(); ?>admin/slide/view_slide/<?php echo $row['slider_id']; ?>">แก้ไขข้อมูล</a>
                                                        <a class="dropdown-item" href="<?= base_url(); ?>admin/slide/del_slide/<?php echo $row['slider_id']; ?>">ลบข้อมูล</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
