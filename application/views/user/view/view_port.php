        ...
        <div class="container">
            ...
            ?>
                    <div class="row pt-5">
                        ...
                        <a href="<?= base_url('user/get_port') ?>" class="sidebar-link">
                            <span class="sidebar-text">ผลงานของเรา&nbsp;>&nbsp;</span>
                        </a>
                        <a href="<?= base_url('user/view_port/') . $row['port_id']; ?>">
                            <span class="sidebar-text"><?= $row['port_title']; ?></span>
                        </a>
                    </div>
                    <h3 class="pt-4 pl-3"><?= $row['port_title']; ?></h3>
                    <div class="row pb-5">
                        <div class="col-12 pd-port">
                            <p><?= $row['port_detail']; ?></p>
                        </div>
                    </div>
            <?php }
