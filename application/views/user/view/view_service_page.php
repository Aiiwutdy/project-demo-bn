        ...
        <div class="container">
            ...
            ?>
                    <div class="row pt-5">
                        ...
                        <a href="<?= base_url('user/get_service') ?>" class="sidebar-link">
                            <span class="sidebar-text">บริการของเรา&nbsp;>&nbsp;</span>
                        </a>
                        <a href="<?= base_url('user/view_service_page/') . $row['service_id']; ?>" class="">
                            <span class="sidebar-text"><?= $row['service_title']; ?></span>
                        </a>
                    </div>
                    <h3 class="text-left pt-4"><?= $row['service_title']; ?></h3>
                    <div class="row pb-4">
